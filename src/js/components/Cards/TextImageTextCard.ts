...
export default class TextImageTextCard extends PIXI.Container implements Card {
    constructor() {
        super();
    ...
    initializeContentHolders(primary: string, label: string, secondaryImage: string) {
        ...
        const labelStyle = new PIXI.TextStyle({
            ...
            fill: "white",
            wordWrap: true,
            wordWrapWidth: window.innerWidth * 0.15,
            align: "center",
            dropShadowBlur: 10
        });
        const labelStylePrimary = new PIXI.TextStyle({
            fontSize: 10 + Math.random() * 48,
            fill: "white",
            wordWrap: true,
        ...
        this.primaryLabel = new PIXI.Text(primary, labelStylePrimary);
        this.label.x = window.innerHeight * 0.01;
        this.label.y = window.innerHeight * 0.01;
        this.primaryContainer.addChild(this.primaryLabel);
    }
    ...
    private primaryLabel: PIXI.Text = null;
