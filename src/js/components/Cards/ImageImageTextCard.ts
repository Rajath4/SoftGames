...
export default class ImageImageTextCard extends PIXI.Container implements Card {
    constructor() {
        super();
    ...
    initializeContentHolders(primaryImage: string, secondaryImage: string, label: string) {
        ...
        this.secondaryContainer2.addChild(this.label);

        this.secondaryImage = PIXI.Sprite.from(secondaryImage);
        this.secondaryImage.width = window.innerWidth * 0.5;
        this.secondaryImage.height = window.innerHeight * 0.15;
        this.secondaryContainer1.addChild(this.secondaryImage);
